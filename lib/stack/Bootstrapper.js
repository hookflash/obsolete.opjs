...
// HACK: Temporary until proper identity auth is built in and online service is working.
return Q.resolve("http://" + Util.getHost() + "/.helpers/" + method);
...
// HACK: Temporary until proper lockbox online service is working.
return Q.resolve("http://" + Util.getHost() + "/.helpers/" + method);
  ...
  function urlForHost(host) {
    ...
    var url = "https://" + host + "/.well-known/openpeer-services-get";
