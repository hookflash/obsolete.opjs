define([
  ...
  'opjs/stack/PublicationRepository',
  'opjs/events',
  'opjs/util'
], function (Bootstrapper, NamespaceGrant, Identity, Lockbox, PeerFiles, AccountFinder, PublicationRepository, Events, Util) {
  'use strict';
  ...
  function Account(context, stack, location) {
    ...
    self._pubrepo = new PublicationRepository(self._context, self);
