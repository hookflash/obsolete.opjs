define([
  ...
  'opjs/events',
  'opjs/util'
], function (Lockbox, PeerFiles, AccountFinder, Peer, Events, Util) {
  'use strict';
  ...
  function Account(stack) {
    ...
    self._ready = self._lockbox.ready().then(function() {
  ...
  Account.prototype.getBootstrapper = function() {
    if (this._ready === null) return Q.reject(new Error("Object has been destroyed"));
    return this._stack.getBootstrapper();
  }
