...
// inner
        self._account.getBootstrapper().getIdentityService("identity-access-inner-frame").then(function(url) {
          ...
          // if context is dev/test, should emit event to tell test to input data
          // make context event emitter "test:inner-frame-ready"
          // then the test should emit "test:inner-frame-ready:inject" to run code inside inner frame

          // Move grant code from lockbox code to node server
          ...
          // TODO: load outerframe instead of inner frame
          // this makes things compatable with iOS client
          // outerframe should be in context outerFrameUrl
          // Then add logic to communicate from outerframe
